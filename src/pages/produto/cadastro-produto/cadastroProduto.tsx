...
class CadastroProduto extends React.Component<CadastroProdutoProps, State> {
    ...
    return (
      ...
      >
        <div>
          ...
          />
          {errors.Nome && <p className="text-red-500 text-xs mt-1">{errors.Nome}</p>} {/* Exibe erro se houver */}
          ...
          <input
            ...
            className="px-3 py-2 rounded-2xl border-gray-400"
          />
          {errors.Preço && <p className="text-red-500 text-xs mt-1">{errors.Preço}</p>} {/* Exibe erro se houver */}
        </div>
      </Modal>
    );
  }
